...
For both the AVP and FIVB tournaments, a team consists of 2 players. Each player in the team either comes from the same country or they come from different countries. Thus, in this section, our analysis focuses on finding the countries that had the most number of winning teams. This will help us find the countries that had the most winning players. 
...
- Lastly, we rearranged the data to show the total count in descending order and we also renamed the variables to make it more meaningful.
...
```{r subset-of-USA-combos, echo=FALSE}
